...
DELETE FROM DW${INSTANCE}T_TMP_ACC_FND.FND_STK_FCT_01_FCT_STG
;

.IF ERRORCODE <> 0 THEN .QUIT 101

INSERT INTO DW${INSTANCE}T_TMP_ACC_FND.FND_STK_FCT_01_FCT_STG
(
    business_date,
    loc_wid,
    item_wid,
...
COLLECT STATISTICS COLUMN(business_date,loc_wid,item_wid) ON DW${INSTANCE}T_TMP_ACC_FND.FND_STK_FCT_01_FCT_STG
;
.IF ERRORCODE <> 0 THEN .QUIT 101
