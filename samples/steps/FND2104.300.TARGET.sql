...
*/
MERGE INTO DW${INSTANCE}T_TMP_ACC_FND.FND_STK_FCT_PVT_STG AS T
USING DW${INSTANCE}T_TMP_ACC_FND.FND_STK_FCT_01_FCT_STG AS S
...
COLLECT STATISTICS COLUMN(business_date,loc_wid,item_wid) ON DW${INSTANCE}T_TMP_ACC_FND.FND_STK_FCT_PVT_STG
;
.IF ERRORCODE <> 0 THEN .QUIT 101
