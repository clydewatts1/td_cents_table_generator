...
# ===============================================================================
# ===============================================================================
# File Name           : FND1013.300.TARGET.sql
# Pattern             : 
...
/* Lock target table */
LOCKING DW${INSTANCE}V_ACC_FND.DW_FND_DATE_DIM_HIST FOR WRITE
;
.IF ERRORCODE <> 0 THEN .QUIT 101

/* Update the target table by closing of the previous records */
UPDATE TRG FROM  DW${INSTANCE}V_ACC_FND.DW_FND_DATE_DIM_HIST AS TRG
...
AND TRG.calendar_dt = SRC.calendar_dt 
    
;
.IF ERRORCODE <> 0 THEN .QUIT 101

/* INSERT INTO target table */
INSERT INTO DW${INSTANCE}V_ACC_FND.DW_FND_DATE_DIM_HIST
(
    calendar_dt, 
    year_start_dt, 
    year_end_dt, 
...
SELECT
    ...
    SRC.season_code AS season_code, 
    SRC.season_name AS season_name, 
    SRC.season_description AS season_description, 
    SRC.season_map AS season_map, 
    SRC.season_wid AS season_wid, 
    ...
    SRC.ty_cstm_cal_dy_wid AS ty_cstm_cal_dy_wid, 
    SRC.ty_cstm_cal_wk_wid AS ty_cstm_cal_wk_wid, 
    SRC.ty_cstm_cal_prd_wid AS ty_cstm_cal_prd_wid, 
    SRC.ty_cstm_cal_yr_wid AS ty_cstm_cal_yr_wid, 
    SRC.ly_cstm_cal_dy_wid AS ly_cstm_cal_dy_wid, 
    SRC.ly_cstm_cal_wk_wid AS ly_cstm_cal_wk_wid, 
    SRC.ly_cstm_cal_prd_wid AS ly_cstm_cal_prd_wid, 
    SRC.ly_cstm_cal_yr_wid AS ly_cstm_cal_yr_wid, 
    SRC.lly_cstm_cal_dy_wid AS lly_cstm_cal_dy_wid, 
    SRC.lly_cstm_cal_wk_wid AS lly_cstm_cal_wk_wid, 
    SRC.lly_cstm_cal_prd_wid AS lly_cstm_cal_prd_wid, 
    SRC.lly_cstm_cal_yr_wid AS lly_cstm_cal_yr_wid, 
    SRC.llly_cstm_cal_dy_wid AS llly_cstm_cal_dy_wid, 
    SRC.llly_cstm_cal_wk_wid AS llly_cstm_cal_wk_wid, 
    SRC.llly_cstm_cal_prd_wid AS llly_cstm_cal_prd_wid, 
    SRC.llly_cstm_cal_yr_wid AS llly_cstm_cal_yr_wid, 
    SRC.ny_cstm_cal_dy_wid AS ny_cstm_cal_dy_wid, 
    SRC.ny_cstm_cal_wk_wid AS ny_cstm_cal_wk_wid, 
    SRC.ny_cstm_cal_prd_wid AS ny_cstm_cal_prd_wid, 
    SRC.ny_cstm_cal_yr_wid AS ny_cstm_cal_yr_wid, 
    SRC.eff_from_dt,
    SRC.eff_to_dt,
    SRC.del_ind,
    SRC.run_id,
