...
# ===============================================================================
# ===============================================================================
# File Name           : FND2107.300.TARGET.sql
# Pattern             : 
...
/* Set query band */
SET QUERY_BAND = 'ApplicationName=TJC;Group=FND_BASE;JobId=FND2107.300.TARGET.sql;JobSeq=300;Instance=T04;RUNID=28;STREAMID=TEST;' UPDATE FOR SESSION
;
...
USING DWT04T_TMP_ACC_FND.FND_STK_FCT_02_FCT_STG AS S
