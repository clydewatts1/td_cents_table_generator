...
/* Set query band */
SET QUERY_BAND = 'ApplicationName=TJC;Group=FND_BASE;JobId=FND2103.310.VALIDATE.sql;JobSeq=310;Instance=T04;RUNID=3700;STREAMID=TEST;' UPDATE FOR SESSION
;
...
--              'DWT04T_TMP_ACC_FND.FND_STK_FCT_01_FCT_STG' contains records
...
WITH TST AS (
    ...
    FROM
        DWT04T_TMP_ACC_FND.FND_STK_FCT_01_FCT_STG
    HAVING
