...
/* Set query band */
SET QUERY_BAND = 'ApplicationName=TJC;Group=FND_BASE;JobId=FND2230.300.TARGET.sql;JobSeq=300;Instance=T04;RUNID=5829;STREAMID=TEST;' UPDATE FOR SESSION
;
...
SELECT
    ...
    5829 AS run_id, -- Populated from a script variable.
