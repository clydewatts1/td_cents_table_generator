...
# ===============================================================================
# ===============================================================================
# File Name           : FND2103.300.VALIDATE.sql
# Pattern             : 
...
/* Set query band */
SET QUERY_BAND = 'ApplicationName=TJC;Group=FND_BASE;JobId=FND2103.300.VALIDATE.sql;JobSeq=300;Instance=T04;RUNID=963;STREAMID=TEST;' UPDATE FOR SESSION
;
...
--              'DWT04T_TMP_ACC_FND.FND_STK_FCT_01_FCT_STG' based on the
