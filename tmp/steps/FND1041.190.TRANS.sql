...
/* Set query band */
SET QUERY_BAND = 'ApplicationName=TJC;Group=FND_BASE;JobId=FND1041.190.TRANS.sql;JobSeq=190;Instance=T04;RUNID=7852;STREAMID=TEST;' UPDATE FOR SESSION
;
...
DELETE FROM DWT04T_TMP_ACC_FND.FND_MERC_HIERARCHY_DIM
;

--.IF ERRORCODE <> 0 THEN .QUIT 101

INSERT INTO DWT04T_TMP_ACC_FND.FND_MERC_HIERARCHY_DIM
(
    merch_hiery_wid,
    company_cd,
    pmk_co_wid,
...
COLLECT STATISTICS COLUMN(merch_hiery_wid) ON DWT04T_TMP_ACC_FND.FND_MERC_HIERARCHY_DIM
;
--.IF ERRORCODE <> 0 THEN .QUIT 101
