...
# ===============================================================================
# ===============================================================================
# File Name           : FND2104.300.TARGET.sql
# Pattern             : 
...
/* Set query band */
SET QUERY_BAND = 'ApplicationName=TJC;Group=FND_BASE;JobId=FND2104.300.TARGET.sql;JobSeq=300;Instance=T04;RUNID=9267;STREAMID=TEST;' UPDATE FOR SESSION
;
...
/*
This MERGE statement updates the target pivot table (FND_STK_FCT_PVT_STG)
from the source staging table (FND_STK_FCT_01_FCT_STG).
Key Logic:
...
*/
MERGE INTO DWT04T_TMP_ACC_FND.FND_STK_FCT_PVT_STG AS T
USING DWT04T_TMP_ACC_FND.FND_STK_FCT_01_FCT_STG AS S
...
COLLECT STATISTICS COLUMN(business_date,loc_wid,item_wid) ON DWT04T_TMP_ACC_FND.FND_STK_FCT_PVT_STG
;
--.IF ERRORCODE <> 0 THEN .QUIT 101
