...
/* Lock target table */
LOCKING DWT04V_ACC_FND.DW_FND_DATE_DIM_HIST FOR WRITE
;
--.IF ERRORCODE <> 0 THEN .QUIT 101

/* Update the target table by closing of the previous records */
UPDATE TRG FROM  DWT04V_ACC_FND.DW_FND_DATE_DIM_HIST AS TRG
                ,DWT04T_TMP_ACC_FND.FND1013_VALID AS SRC
...
INSERT INTO DWT04V_ACC_FND.DW_FND_DATE_DIM_HIST
(
    calendar_dt, 
    year_start_dt, 
    year_end_dt, 
...
SELECT
    ...
    SRC.job_id,
    SRC.update_job_id
FROM DWT04T_TMP_ACC_FND.FND1013_VALID AS SRC
;
--.IF ERRORCODE <> 0 THEN .QUIT 101
