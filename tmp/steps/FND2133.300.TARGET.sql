...
WHEN MATCHED THEN
    UPDATE SET
        ...
        update_run_id = 3471, -- Placeholder for the run ID
...
WHEN NOT MATCHED THEN
    ...
    VALUES (
        ...
        date '2025-08-03', -- Teradata function to get the date of the Saturday of the week.
        date '2024-08-07', -- Calculate the date for the same day last year (approximated).
        date '2025-08-07', -- The effective start date for this record.
        DATE '3500-12-31', -- A high-date to indicate the record is currently active.
        0, -- Deletion indicator; 0 means the record is active.
        3471, -- Placeholder for the initial run ID.
