...
/* Set query band */
SET QUERY_BAND = 'ApplicationName=TJC;Group=FND_BASE;JobId=FND2203.300.VALIDATE.sql;JobSeq=300;Instance=T04;RUNID=8972;STREAMID=TEST;' UPDATE FOR SESSION
;
...
--              'DWT04T_TMP_ACC_FND.FND_SLS_FCT_01_FCT_STG' based on the
