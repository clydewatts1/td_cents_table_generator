...
/* Set query band */
SET QUERY_BAND = 'ApplicationName=TJC;Group=FND_BASE;JobId=FND2204.300.TARGET.sql;JobSeq=300;Instance=T04;RUNID=4084;STREAMID=TEST;' UPDATE FOR SESSION
;
...
*/
MERGE INTO DWT04T_TMP_ACC_FND.FND_SLS_FCT_PVT_STG AS T
USING DWT04T_TMP_ACC_FND.FND_SLS_FCT_01_FCT_STG AS S
