...
/*RFC 17880/CHG0031571- CAST AS DATE APPLIED*/  
   -- cross join VOL_DY_TY AS  ty
    ...
    /* Get a accrued adjustment total for the week , so the date range will be from sunday - start of week
       to end of week */
    /* Use RUNDATE AS date '2025-08-06' */
    AND  CAST(STK_ADJS_TY.Stock_Adjustment_Date AS DATE)  BETWEEN TD_SUNDAY(date '2025-08-06') AND TD_SUNDAY(date '2025-08-06')+6
    ) STK_ADJ
  GROUP BY 1,2,3
    ) ,
-- Markdowns
...
SELECT item_id,
  ...
  WHERE MKD1.Current_Flag = 'Y' 
    ...
    AND date '2025-08-06' between MKD1.Item_Price_From_Date and MKD1.Item_Price_To_Date  
...
SELECT 
 ...
 WHERE IPD.Current_Flag = 'Y' 
  ...
  AND date '2025-08-06' between IPD.Item_Price_From_Date and IPD.Item_Price_To_Date
...
WHERE STK.stock_inventory_date = date '2025-08-06' /* Use RUNDATE */
