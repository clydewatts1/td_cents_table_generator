...
SELECT
    ...
    8135 AS run_id, -- Populated from a script variable.
...
SET
    wkly_flg = 'N'
WHERE
    business_date BETWEEN date '2025-08-03' AND date '2025-08-09'
    AND business_date <> date '2025-08-06' -- Exclude the current run date from the update
    AND wkly_flg = 'Y';
--.IF ERRORCODE <> 0 THEN .QUIT 101;
