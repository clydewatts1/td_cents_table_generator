...
# ===============================================================================
# ===============================================================================
# File Name           : FND1012.300.TARGET.sql
# Pattern             : 
...
/* Set query band */
SET QUERY_BAND = 'ApplicationName=TJC;Group=FND_BASE;JobId=FND1012.300.TARGET.sql;JobSeq=300;Instance=T04;RUNID=9941;STREAMID=TEST;' UPDATE FOR SESSION
;
...
SELECT
    ...
    /* Control Columns */
    date '2025-08-22' AS eff_from_dt,
