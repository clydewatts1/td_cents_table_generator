...
WITH TRANSACTIONS_PREPARED AS (
    ...
    WHERE SLS.sales_business_dt = date '2025-08-06'
...
VOL_SLS_TXN_TY_DATA AS (
    SELECT
        ...
        item_wid,
        item_id,
        date '2025-08-06' AS business_day_id,
...
VOL_TENDER_SALES_TXN_TY AS (
    SELECT
        ...
        date '2025-08-06' AS sales_business_date,
        TNDR_TY.effective_from_dt,
        tender_type_code,
        tender_sales_amount
    FROM DWT04A_ACC_ORR.DW_TNDR_SALES_TRX_LN_FV AS TNDR_TY
    WHERE TNDR_TY.sales_business_date = date '2025-08-06' -- Filtering for T-2 due to upstream issue.
...
VOL_TENDER_SALES_TXN_LA_TY AS (
    ...
    FROM DWT04A_ACC_ORR.DW_TNDR_SALES_TRX_LN_FV AS TNDR_T
