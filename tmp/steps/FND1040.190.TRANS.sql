...
/* Set query band */
SET QUERY_BAND = 'ApplicationName=TJC;Group=FND_BASE;JobId=FND1040.190.TRANS.sql;JobSeq=190;Instance=T04;RUNID=1056;STREAMID=TEST;' UPDATE FOR SESSION
;
...
DELETE FROM DWT04T_TMP_ACC_FND.FND1040_TRANS
;

--.IF ERRORCODE <> 0 THEN .QUIT 101

INSERT INTO DWT04T_TMP_ACC_FND.FND1040_TRANS
(
    styl_wid,
    item_sbclas_wid
)
    ...
    WHERE 
        ...
        AND  PERIOD(stl.eff_from_dttm, stl.eff_to_dttm) CONTAINS ((date '2025-08-19' + 1)(TIMESTAMP(0)))
...
COLLECT STATISTICS COLUMN(styl_wid) ON DWT04T_TMP_ACC_FND.FND1040_TRANS
;
--.IF ERRORCODE <> 0 THEN .QUIT 101
