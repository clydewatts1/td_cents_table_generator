...
*-------------------------------------------------------------------------------*/
COMMENT ON DW${INSTANCE}T_TMP_ACC_FND.FND1043_TRANS AS 'This is the foundation store hierarchy dimension'
;
...
COMMENT ON DW${INSTANCE}T_TMP_ACC_FND.FND1043_TRANS.company_version_num AS 'This is the current version associated with style and company code'
;

COMMENT ON DW${INSTANCE}T_TMP_ACC_FND.FND1043_TRANS.division_cd AS 'This is the division code'
;

COMMENT ON DW${INSTANCE}T_TMP_ACC_FND.FND1043_TRANS.division_version_num AS 'This is the current version associated with style and division code'
;

COMMENT ON DW${INSTANCE}T_TMP_ACC_FND.FND1043_TRANS.department_cd AS 'The is the department code'
;

COMMENT ON DW${INSTANCE}T_TMP_ACC_FND.FND1043_TRANS.department_version_num AS 'This is the current version associated with style and department code'
;

COMMENT ON DW${INSTANCE}T_TMP_ACC_FND.FND1043_TRANS.class_cd AS 'This is the class / section code'
;

COMMENT ON DW${INSTANCE}T_TMP_ACC_FND.FND1043_TRANS.class_version_num AS 'This is the current version associated with style and class / section code'
;

COMMENT ON DW${INSTANCE}T_TMP_ACC_FND.FND1043_TRANS.subclass_grp_cd AS 'This is the group subclass - group section'
;

COMMENT ON DW${INSTANCE}T_TMP_ACC_FND.FND1043_TRANS.subclass_grp_version_num AS 'This is the current version associated with style and subclass - group'
;

COMMENT ON DW${INSTANCE}T_TMP_ACC_FND.FND1043_TRANS.subclass_cd AS 'This is the sub-classa / subsection code'
;

COMMENT ON DW${INSTANCE}T_TMP_ACC_FND.FND1043_TRANS.subclass_version_num AS 'This is the current version associated with style and section - group'
;
...
;
    ...
    /* Control columns for auditing */
COMMENT ON DW${INSTANCE}T_TMP_ACC_FND.FND1043_TRANS.eff_from_dt AS 'The date from which the record is valid'
;

COMMENT ON DW${INSTANCE}T_TMP_ACC_FND.FND1043_TRANS.eff_to_dt AS 'The date until which the record is valid'
;

COMMENT ON DW${INSTANCE}T_TMP_ACC_FND.FND1043_TRANS.del_ind AS 'The deletion indicator for the record, 0 for active, 1 for deleted'
;

COMMENT ON DW${INSTANCE}T_TMP_ACC_FND.FND1043_TRANS.run_id AS 'The run id of the ETL job that created the record'
;

COMMENT ON DW${INSTANCE}T_TMP_ACC_FND.FND1043_TRANS.update_run_id AS 'The run id of the ETL job that last updated the record'
;
COMMENT ON DW${INSTANCE}T_TMP_ACC_FND.FND1043_TRANS.job_id AS 'The job id of the ETL job that created the record'
;
COMMENT ON DW${INSTANCE}T_TMP_ACC_FND.FND1043_TRANS.update_job_id AS 'The job id of the ETL job that last updated the record'
;
