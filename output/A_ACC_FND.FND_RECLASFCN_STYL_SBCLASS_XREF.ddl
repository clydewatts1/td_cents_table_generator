...
COMMENT ON COLUMN DW${INSTANCE}A_ACC_FND.FND_RECLASFCN_STYL_SBCLASS_XREF.item_sbclas_wid AS 'This contains the item subclass wid - this is the lowest grain for the merchant hierarchy'
;
