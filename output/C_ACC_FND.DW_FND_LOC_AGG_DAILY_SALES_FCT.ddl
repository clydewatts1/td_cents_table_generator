...
/*----------------------------------------------------------------------
* FileName: C_ACC_FND.DW_FND_LOC_AGG_DAILY_SALES_FCT.ddl
...
COMMENT ON COLUMN DW${INSTANCE}C_ACC_FND.DW_FND_LOC_AGG_DAILY_SALES_FCT.loc_wid AS 'Location ID Surrogate KEY (PK)'
;

COMMENT ON COLUMN DW${INSTANCE}C_ACC_FND.DW_FND_LOC_AGG_DAILY_SALES_FCT.item_wid AS 'Item ID Surrogate Key (PK)'
;
