...
/*----------------------------------------------------------------------
* FileName: T_ACC_FND.DW_FND_LOC_AGG_DAILY_ORDER_FCT.ddl
...
CREATE MULTISET TABLE DW${INSTANCE}T_ACC_FND.DW_FND_LOC_AGG_DAILY_ORDER_FCT
    ...
    merch_invc_dt DATE    ,
    plan_vs_act_handover_date DATE    ,
    last_pick_date DATE    ,
    last_recieved_date DATE    ,
    on_time_delivery CHAR(1)    ,
    fir_commitment_due_date DATE    ,
    fir_commitment_week VARCHAR(30)    ,
    booked_delivery_date DATE    ,
    ...
    packing_method VARCHAR(255)    COMPRESS(Flat')  ,
