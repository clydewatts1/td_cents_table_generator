...
/*----------------------------------------------------------------------
* FileName: T_TMP_ACC_FND.FND2130_TRANS.ddl
...
COMMENT ON DW${INSTANCE}T_TMP_ACC_FND.FND2130_TRANS.lcp_intake AS 'This Column is used identify the LCP intake Value'
;

COMMENT ON DW${INSTANCE}T_TMP_ACC_FND.FND2130_TRANS.lcp_gross AS 'This Column is used identify the LCP Gross Value'
;
