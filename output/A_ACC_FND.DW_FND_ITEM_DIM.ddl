...
/*----------------------------------------------------------------------
* FileName: A_ACC_FND.DW_FND_ITEM_DIM.ddl
...
COMMENT ON COLUMN DW${INSTANCE}A_ACC_FND.DW_FND_ITEM_DIM.item_wid AS 'ITEM WID'
;
...
COMMENT ON COLUMN DW${INSTANCE}A_ACC_FND.DW_FND_ITEM_DIM.styl_wid AS 'Style Wid'
;
