...
/*----------------------------------------------------------------------
* FileName: T_ACC_FND.DW_FND_ITEM_HIST_DIM.ddl
...
COMMENT ON DW${INSTANCE}T_ACC_FND.DW_FND_ITEM_HIST_DIM.item_wid AS 'ITEM WID'
;
...
COMMENT ON DW${INSTANCE}T_ACC_FND.DW_FND_ITEM_HIST_DIM.styl_wid AS 'Style Wid'
;
