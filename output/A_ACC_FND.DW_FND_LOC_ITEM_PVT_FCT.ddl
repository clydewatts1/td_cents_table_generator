...
/*----------------------------------------------------------------------
* FileName: A_ACC_FND.DW_FND_LOC_ITEM_PVT_FCT.ddl
...
COMMENT ON COLUMN DW${INSTANCE}A_ACC_FND.DW_FND_LOC_ITEM_PVT_FCT.loc_wid AS 'Location ID Surrogate KEY (PK)'
;

COMMENT ON COLUMN DW${INSTANCE}A_ACC_FND.DW_FND_LOC_ITEM_PVT_FCT.item_wid AS 'Item ID Surrogate Key (PK)'
;

COMMENT ON COLUMN DW${INSTANCE}A_ACC_FND.DW_FND_LOC_ITEM_PVT_FCT.ty_wk_business_date AS 'The week business date ( TD_SATURDAY )'
;

COMMENT ON COLUMN DW${INSTANCE}A_ACC_FND.DW_FND_LOC_ITEM_PVT_FCT.ly_business_date AS 'Last year business date'
;

COMMENT ON COLUMN DW${INSTANCE}A_ACC_FND.DW_FND_LOC_ITEM_PVT_FCT.ly_wk_business_date AS 'Last year wk_business_date ( Saturday )'
;

COMMENT ON COLUMN DW${INSTANCE}A_ACC_FND.DW_FND_LOC_ITEM_PVT_FCT.lw_business_date AS 'Last week business date'
;
