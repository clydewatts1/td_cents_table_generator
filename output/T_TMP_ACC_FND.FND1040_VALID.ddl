...
COMMENT ON DW${INSTANCE}T_TMP_ACC_FND.FND1040_VALID.item_sbclas_wid AS 'This contains the item subclass wid - this is the lowest grain for the merchant hierarchy'
;
