...
CREATE MULTISET TABLE DW${INSTANCE}T_TMP_ACC_FND.FND_SLS_FCT_PVT_STG
    ...
    PRIMARY INDEX ( loc_wid ,Item_Id ) PARTITION BY RANGE_N(Business_Date BETWEEN DATE '2015-01-01' AND DATE '2030-12-31' EACH INTERVAL '1' DAY )
;
...
COMMENT ON DW${INSTANCE}T_TMP_ACC_FND.FND_SLS_FCT_PVT_STG.item_id AS 'Item ID Surrogate Key (PK)'
;
