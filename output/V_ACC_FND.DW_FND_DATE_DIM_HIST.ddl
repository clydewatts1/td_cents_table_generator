...
/*----------------------------------------------------------------------
* FileName: V_ACC_FND.DW_FND_DATE_DIM_HIST.ddl
...
COMMENT ON COLUMN DW${INSTANCE}V_ACC_FND.DW_FND_DATE_DIM_HIST.ty_cstm_cal_dy_wid AS 'Surrogate key for the day in the current year (TY).'
;

COMMENT ON COLUMN DW${INSTANCE}V_ACC_FND.DW_FND_DATE_DIM_HIST.ty_cstm_cal_wk_wid AS 'Surrogate key for the week in the current year (TY).'
;

COMMENT ON COLUMN DW${INSTANCE}V_ACC_FND.DW_FND_DATE_DIM_HIST.ty_cstm_cal_prd_wid AS 'Surrogate key for the period (month) in the current year (TY).'
;

COMMENT ON COLUMN DW${INSTANCE}V_ACC_FND.DW_FND_DATE_DIM_HIST.ty_cstm_cal_yr_wid AS 'Surrogate key for the year of the current year (TY).'
;

COMMENT ON COLUMN DW${INSTANCE}V_ACC_FND.DW_FND_DATE_DIM_HIST.ly_cstm_cal_dy_wid AS 'Surrogate key for the corresponding day last year (LY).'
;

COMMENT ON COLUMN DW${INSTANCE}V_ACC_FND.DW_FND_DATE_DIM_HIST.ly_cstm_cal_wk_wid AS 'Surrogate key for the corresponding week last year (LY).'
;

COMMENT ON COLUMN DW${INSTANCE}V_ACC_FND.DW_FND_DATE_DIM_HIST.ly_cstm_cal_prd_wid AS 'Surrogate key for the corresponding period (month) last year (LY).'
;

COMMENT ON COLUMN DW${INSTANCE}V_ACC_FND.DW_FND_DATE_DIM_HIST.ly_cstm_cal_yr_wid AS 'Surrogate key for the corresponding year last year (LY).'
;

COMMENT ON COLUMN DW${INSTANCE}V_ACC_FND.DW_FND_DATE_DIM_HIST.lly_cstm_cal_dy_wid AS 'Surrogate key for the corresponding day two years ago (LLY).'
;

COMMENT ON COLUMN DW${INSTANCE}V_ACC_FND.DW_FND_DATE_DIM_HIST.lly_cstm_cal_wk_wid AS 'Surrogate key for the corresponding week two years ago (LLY).'
;

COMMENT ON COLUMN DW${INSTANCE}V_ACC_FND.DW_FND_DATE_DIM_HIST.lly_cstm_cal_prd_wid AS 'Surrogate key for the corresponding period (month) two years ago (LLY).'
;

COMMENT ON COLUMN DW${INSTANCE}V_ACC_FND.DW_FND_DATE_DIM_HIST.lly_cstm_cal_yr_wid AS 'Surrogate key for the corresponding year two years ago (LLY).'
;

COMMENT ON COLUMN DW${INSTANCE}V_ACC_FND.DW_FND_DATE_DIM_HIST.llly_cstm_cal_dy_wid AS 'Surrogate key for the corresponding day three years ago (LLLY).'
;

COMMENT ON COLUMN DW${INSTANCE}V_ACC_FND.DW_FND_DATE_DIM_HIST.llly_cstm_cal_wk_wid AS 'Surrogate key for the corresponding week three years ago (LLLY).'
;

COMMENT ON COLUMN DW${INSTANCE}V_ACC_FND.DW_FND_DATE_DIM_HIST.llly_cstm_cal_prd_wid AS 'Surrogate key for the corresponding period (month) three years ago (LLLY).'
;

COMMENT ON COLUMN DW${INSTANCE}V_ACC_FND.DW_FND_DATE_DIM_HIST.llly_cstm_cal_yr_wid AS 'Surrogate key for the corresponding year three years ago (LLLY).'
;

COMMENT ON COLUMN DW${INSTANCE}V_ACC_FND.DW_FND_DATE_DIM_HIST.ny_cstm_cal_dy_wid AS 'Surrogate key for the corresponding day next year (NY).'
;

COMMENT ON COLUMN DW${INSTANCE}V_ACC_FND.DW_FND_DATE_DIM_HIST.ny_cstm_cal_wk_wid AS 'Surrogate key for the corresponding week next year (NY).'
;

COMMENT ON COLUMN DW${INSTANCE}V_ACC_FND.DW_FND_DATE_DIM_HIST.ny_cstm_cal_prd_wid AS 'Surrogate key for the corresponding period (month) next year (NY).'
;

COMMENT ON COLUMN DW${INSTANCE}V_ACC_FND.DW_FND_DATE_DIM_HIST.ny_cstm_cal_yr_wid AS 'Surrogate key for the corresponding year next year (NY).'
;
