...
/*----------------------------------------------------------------------
* FileName: T_TMP_ACC_FND.FND_STK_FCT_PVT_STG.ddl
...
COMMENT ON DW${INSTANCE}T_TMP_ACC_FND.FND_STK_FCT_PVT_STG.loc_wid AS 'Location ID Surrogate KEY (PK)'
;

COMMENT ON DW${INSTANCE}T_TMP_ACC_FND.FND_STK_FCT_PVT_STG.item_wid AS 'Item ID Surrogate Key (PK)'
;
