...
/*----------------------------------------------------------------------
* FileName: T_TMP_ACC_FND.FND_SLS_FCT_01_FCT_STG.ddl
...
CREATE MULTISET TABLE DW${INSTANCE}T_TMP_ACC_FND.FND_SLS_FCT_01_FCT_STG
    ...
    sales_value DECIMAL(18,10)    COMPRESS(0) ,
    sales_units INTEGER    COMPRESS(0) ,
    sales_transaction_count INTEGER    COMPRESS(0) ,
    return_value DECIMAL(18,10)    COMPRESS(0) ,
    return_units INTEGER    COMPRESS(0) ,
    return_transaction_count INTEGER    COMPRESS(0) ,
    exchange_value DECIMAL(18,10)    COMPRESS(0) ,
    exchange_units INTEGER    COMPRESS(0) ,
    exchange_transaction_count INTEGER    COMPRESS(0) ,
    emp_discount_exchange_value DECIMAL(18,10)    COMPRESS(0) ,
    emp_discount_exchange_units INTEGER    COMPRESS(0) ,
    emp_discount_exchange_transaction_count INTEGER    COMPRESS(0) ,
    emp_discount_sales_value DECIMAL(18,10)    COMPRESS(0) ,
    emp_discount_sales_units INTEGER    COMPRESS(0) ,
    emp_discount_sales_transaction_count INTEGER    COMPRESS(0) ,
    emp_discount_return_value DECIMAL(18,10)    COMPRESS(0) ,
    emp_discount_return_units INTEGER    COMPRESS(0) ,
    emp_discount_return_transaction_count INTEGER    COMPRESS(0) ,
    sales_tax_amt DECIMAL(18,10)    COMPRESS(0) ,
    return_tax_amt DECIMAL(18,10)    COMPRESS(0) ,
    void_transaction_count INTEGER    COMPRESS(0) ,
    post_void_transaction_count INTEGER    COMPRESS(0) ,
    other_transaction_count INTEGER    COMPRESS(0) ,
    sales_manual_markup_amt DECIMAL(18,10)    COMPRESS(0) ,
    sales_manual_markdown_amt DECIMAL(18,10)    COMPRESS(0) ,
    return_manual_markdown_amt DECIMAL(18,10)    COMPRESS(0) ,
    sales_manual_count INTEGER    COMPRESS(0) ,
    sales_scan_count INTEGER    COMPRESS(0) ,
    exchanges_with_reciepts DECIMAL(18,10)    COMPRESS(0) ,
    exchanges_without_reciepts DECIMAL(18,10)    COMPRESS(0) ,
    returns_with_reciepts DECIMAL(18,10)    COMPRESS(0) ,
    returns_without_reciepts DECIMAL(18,10)    COMPRESS(0) ,
    no_sale_transaction_count INTEGER    COMPRESS(0) ,
    markdown_sales DECIMAL(18,10)    COMPRESS(0) ,
    cash_sales_value DECIMAL(18,10)    COMPRESS(0) ,
    cash_sales_units INTEGER    COMPRESS(0) ,
    cash_sales_transaction_count INTEGER    COMPRESS(0) ,
    card_sales_value DECIMAL(18,10)    COMPRESS(0) ,
    card_sales_units INTEGER    COMPRESS(0) ,
    card_sales_transaction_count INTEGER    COMPRESS(0) ,
    gift_sales_value DECIMAL(18,10)    COMPRESS(0) ,
    gift_sales_units INTEGER    COMPRESS(0) ,
    gift_sales_transaction_count INTEGER    COMPRESS(0) ,
    others_sales_value DECIMAL(18,10)    COMPRESS(0) ,
    others_sales_units INTEGER    COMPRESS(0) ,
    others_sales_transaction_count INTEGER    COMPRESS(0) ,
    cash_return_value DECIMAL(18,10)    COMPRESS(0) ,
    cash_return_units INTEGER    COMPRESS(0) ,
    cash_return_transaction_count INTEGER    COMPRESS(0) ,
    card_return_value DECIMAL(18,10)    COMPRESS(0) ,
    card_return_units INTEGER    COMPRESS(0) ,
    card_return_transaction_count INTEGER    COMPRESS(0) ,
    gift_return_value DECIMAL(18,10)    COMPRESS(0) ,
    gift_return_units INTEGER    COMPRESS(0) ,
    gift_return_transaction_count INTEGER    COMPRESS(0) ,
    others_return_value DECIMAL(18,10)    COMPRESS(0) ,
    others_return_units INTEGER    COMPRESS(0) ,
    others_return_transaction_count INTEGER    COMPRESS(0) ,
    cash_exchange_value DECIMAL(18,10)    COMPRESS(0) ,
    cash_exchange_units INTEGER    COMPRESS(0) ,
    cash_exchange_transaction_count INTEGER    COMPRESS(0) ,
    card_exchange_value DECIMAL(18,10)    COMPRESS(0) ,
    card_exchange_units INTEGER    COMPRESS(0) ,
    card_exchange_transaction_count INTEGER    COMPRESS(0) ,
    gift_exchange_value DECIMAL(18,10)    COMPRESS(0) ,
    gift_exchange_units INTEGER    COMPRESS(0) ,
    gift_exchange_transaction_count INTEGER    COMPRESS(0) ,
    others_exchange_value DECIMAL(18,10)    COMPRESS(0) ,
    others_exchange_units INTEGER    COMPRESS(0) ,
    others_exchange_transaction_count INTEGER    COMPRESS(0) ,
    promotion_sales_value DECIMAL(18,10)    COMPRESS(0) ,
    promotion_sales_units INTEGER    COMPRESS(0) ,
    promotion_sales_transaction_count INTEGER    COMPRESS(0) ,
    clearance_sales_value DECIMAL(18,10)    COMPRESS(0) ,
    clearance_sales_units INTEGER    COMPRESS(0) ,
    clearance_sales_transaction_count INTEGER    COMPRESS(0) ,
    regular_sales_value DECIMAL(18,10)    COMPRESS(0) ,
    regular_sales_units INTEGER    COMPRESS(0) ,
    regular_sales_transaction_count INTEGER    COMPRESS(0) ,
    promotion_return_value DECIMAL(18,10)    COMPRESS(0) ,
    promotion_return_units INTEGER    COMPRESS(0) ,
    promotion_return_transaction_count INTEGER    COMPRESS(0) ,
    clearance_return_value DECIMAL(18,10)    COMPRESS(0) ,
    clearance_return_units INTEGER    COMPRESS(0) ,
    clearance_return_transaction_count INTEGER    COMPRESS(0) ,
    regular_return_value DECIMAL(18,10)    COMPRESS(0) ,
    regular_return_units INTEGER    COMPRESS(0) ,
    regular_return_transaction_count INTEGER    COMPRESS(0) ,
    promotion_exchange_value DECIMAL(18,10)    COMPRESS(0) ,
    promotion_exchange_units INTEGER    COMPRESS(0) ,
    promotion_exchange_transaction_count INTEGER    COMPRESS(0) ,
    clearance_exchange_value DECIMAL(18,10)    COMPRESS(0) ,
    clearance_exchange_units INTEGER    COMPRESS(0) ,
    clearance_exchange_transaction_count INTEGER    COMPRESS(0) ,
    regular_exchange_value DECIMAL(18,10)    COMPRESS(0) ,
    regular_exchange_units INTEGER    COMPRESS(0) ,
    regular_exchange_transaction_count INTEGER    COMPRESS(0)  
    )
