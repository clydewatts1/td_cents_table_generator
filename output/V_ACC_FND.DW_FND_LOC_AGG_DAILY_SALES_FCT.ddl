...
COMMENT ON COLUMN DW${INSTANCE}V_ACC_FND.DW_FND_LOC_AGG_DAILY_SALES_FCT.loc_id AS 'Location ID - this can either be a store or depot (PK)'
;

COMMENT ON COLUMN DW${INSTANCE}V_ACC_FND.DW_FND_LOC_AGG_DAILY_SALES_FCT.item_id AS 'Item ID - this is the SKU Orin ( PK)'
;
